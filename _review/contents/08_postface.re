...
ここまで作ったアプリをWebサービスとして公開するには、PaaS（Platform as a Service）と呼ばれるサービスを使うとかんたんに公開できます。アプリケーションのソースコードを転送するだけでWebサービスを公開できるので、AWSなどのサーバを借りるタイプのものと比べて手軽に使うことができます。RailsアプリではHerokuと呼ばれるサービスがよく使われています。資料としては、 @<href>{https://railsgirls.jp/heroku,『RailsGirlsガイド Heroku に Rails アプリをアップ』} のページが最新の情報へとメンテナンスされていることが多くお勧めです。
 ...
 ** 電子書籍版 @<href>{https://tatsu-zine.com/books/railsguides,https://tatsu-zine.com/books/railsguides}
 ...
 ** 電子書籍版 @<href>{https://tatsu-zine.com/books/railstutorial,https://tatsu-zine.com/books/railstutorial}
 ...
 ** すがわらまさのり、前島真一、橋立友宏、五十嵐邦明、後藤優一 著 技術評論社 ISBN: 978-4-297-11462-6
 ...
 ** 私と松岡さんで書き、べこさんがイラストを担当した書籍です。プログラミングが初めての方へ向けた、Rubyプログラミングの入門書です。プログラミングの基礎である条件分岐、繰り返しの概念を図解を入れて丁寧に説明します。そしてRubyでよく使われる整数、文字列、配列、ハッシュと言ったオブジェクトを説明しています。また、エラー時の対処方法、リファレンスマニュアルの調べ方、デバッグの基礎も学べるので、自分で調べる力をつけることができます。Railsで必要となる知識を学ぶことをゴールにしているので、メソッドやクラス、モジュールの作り方、使い方など、最低限必要となる知識を効率良く学べます。加えて、Gemとそれを束ねるBundlerの使い方を学べます。第3刷よりRuby3.0に対応しました。
 * たのしいRuby 第6版
...
なにより、自分で作りたいアプリを作ってみるのが一番勉強になります。作っている上で、もしもつまづき、インターネットで検索しても分からないことがあったときには、近くのRubyコミュニティへぜひ足を運んでみてください。新しいRubyist（あなたのことです！）を温かく迎えてくれるはずです。Rubyコミュニティは「都市名.rb」という名前で活動していることが多いです。全国各地のRubyコミュニティについて、@<href>{https://github.com/ruby-no-kai/official/wiki/RegionalRubyistMeetUp,地域Rubyの会}のページに情報がまとまっています。また、@<href>{https://rubykaigi.org/,RubyKaigi}や@<href>{https://regional.rubykaigi.org/,地域Ruby会議}と呼ばれるカンファレンスも定期的に開催されています。2020年以降はオンラインで開催されるRubyコミュニティも増えて、全国どこからでも参加しやすくなっています。
 ...
 * 地域Rubyの会
 ** @<href>{https://github.com/ruby-no-kai/official/wiki/RegionalRubyistMeetUp,https://github.com/ruby-no-kai/official/wiki/RegionalRubyistMeetUp}
 * RubyKaigi
...
本書は2012年4月から始めた一橋大学での講義資料からはじまり、そのあと幾度かの改訂を経て現在へ至ります。当時はRuby1.9, Rails3.2という環境でしたので、現在のRuby3.1, Rails7.0までの道のりで、Rubyは10回、Railsは9回のバージョンアップを重ねたことになります。10年前から同じ言語、同じフレームワークを使って仕事ができていることは本当にすごいことです。Railsコアチームのみなさん、コントリビュータのみなさん、GemなどOSS開発者のみなさんへ感謝します。
 ...
 * ガーネットテック373株式会社
 * twitter: igaiga555
 * https://igarashikuniaki.net



群馬高専出身。フリーランスのRuby, Railsエンジニア。2003年、Rubyで書かれたWeb日記アプリtDiaryを使い始めてRubyistになる。一橋大学の非常勤講師として2012年から2年間、RubyとRailsを教える。受託開発会社、Webサービス開発会社CTOなどを経て2017年4月よりフリーランス、2019年7月ガーネットテック373株式会社を設立、同社代表取締役社長。RubyWorld ConferenceやRubyConf台湾などで講演。島根県Ruby合宿、Rails Girls、フィヨルドブートキャンプ、大名エンジニアカレッジなどで講師役を務める。著書に『ゼロからわかる Ruby超入門』、『Railsの教科書』、『パーフェクトRuby on Rails［増補改訂版］』、『RubyとRailsの学習ガイド』ほか。
