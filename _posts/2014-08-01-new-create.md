...
![パラメータの送信側と受信側](assets/new-create/create-controller-params-4.png)
...
![Strong Parameters](assets/new-create/create-strong-parameters.png)
...
![create - 本のデータを作る](assets/new-create/create-model.png)
...
![create - ここまでの流れ](assets/new-create/create-summary.png)
