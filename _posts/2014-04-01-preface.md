...
本書はRuby 2.4.0と、Rails 5.0.1で動作確認をしています。[^1]

[^1]: 2017年1月8日現在、Rubyの最新バージョンは2.4.0、Railsの最新バージョンは5.0.1です。本書の内容はRails 4.2でも同様に実行できますので、Rails 4.2をお使いいただいても大丈夫です。Rails4.2でRails5.0と異なる部分については、その都度補足していきます。
