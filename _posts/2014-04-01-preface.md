...
[^1]: 2017年1月8日現在、Rubyの最新バージョンは2.4.0、Railsの最新バージョンは5.0.1です。本書の内容はRuby 2.3.3でも同様に実行できます。また、Rails 4.2でも同様に実行できますので、Rails 4.2をお使いいただいても大丈夫です。Rails4.2とRails5.0で異なる部分については、その都度補足していきます。
