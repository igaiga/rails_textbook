...
![起動した画面](assets/crud/app_ss/books_index_blank.png)

こんな画面が表示されましたでしょうか。ここから、New Bookリンクをクリックして先へ進み、title欄とmemo欄を記入しCreate Bookボタンを押してみてください。

![データを入力してCreate Bookボタン](assets/crud/app_ss/books_created_data_1.png)

ここからBackボタンを押すと最初の`/books`のページに戻りますが、先ほど入力したデータが表示されていることが分かるかと思います。

![入力したデータが表示される](assets/crud/app_ss/books_index_data_1.png)
...
![index - 一覧画面](assets/crud/app_ss/books_index_data_2.png)
...
![Routes表](assets/crud/figures/index_routes.png)
...
![index画面](assets/crud/app_ss/books_index_data_2.png)
...
- [Rails ガイド: Rails のルーティング](http://railsguides.jp/routing.html)
  - routesについての詳しい解説です。
